                ...
                <div className="panel">
                    <div className="hamburger hide">
                        ...
                        <div className="hamburger-menu">
                            ...
                            <ul>
                                <li>
                                    <Link to="/"  onClick={this.hamburgerClick}>Splash</Link>
                                </li>
                                <li>
                                    <Link to="/home"  onClick={this.hamburgerClick}>Home</Link>
                                </li>
                                <li>
                                    <Link to="/connection/new"  onClick={this.hamburgerClick}>New Connection</Link>
                                </li>
                                <li>
                                    <Link to="/contact/new"  onClick={this.hamburgerClick}>New Contact</Link>
                                </li>
                                <li>
                                    <Link to="/settings"  onClick={this.hamburgerClick}>Settings</Link>
                                </li>
                                <li>
                                    <Link to="/login"  onClick={this.hamburgerClick}>Login</Link>
                                </li>
                                <li>
                                    <Link to="/signup"  onClick={this.hamburgerClick}>Signup</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="menu-block"  onClick={this.hamburgerClick} ></div>
                    </div>
                </div>
